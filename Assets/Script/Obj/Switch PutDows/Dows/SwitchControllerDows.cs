...
public class SwitchControllerDows : MonoBehaviour
{
    ...
    private bool isPressed = false; // สถานะของ switch  ก
    ...
    {
        //#2# ตรวจสอบวัตถุที่มีแท็ก "Box", "Small Box", "Big Box", หรือ "Player"
            ...
            
        {
            ...
            if (weightOnSwitch == 1 && !isPressed)//if (weightOnSwitch == 1)
            {
